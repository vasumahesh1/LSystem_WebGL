...
function loadAssets() {
    ...
    branchInstanced.load('./src/objs/branch1.obj')
        .then(function () {
        return leaf1Instanced.load('./src/objs/leaf3.obj');
    })
        .then(function () {
...
function main() {
    ...
    const camera = new Camera(vec3.fromValues(0, 75, 75), vec3.fromValues(0, 0, 0));
